...
public:
    void SetStopWords(const string& text) {
        ...
        return finish_rating = plus_ratings / ratings.size();
    }
    ...
    void AddDocument(int document_id, const string& document, vector<int> ratings) {
        ...
        int finish_rating = ComputeAverageRating(ratings);

        document_ratings_[document_id] = finish_rating;
